...
// **********************
    ...
    var start_exp_survey_trial = {
      ...
      questions: [
        {prompt: "What's your toloka worker ID (needed for bonus payment)?", rows: 2, columns:50 , required:true}, 
    ...
    var SVO_instruction = {
      ...
      <br> 
      <br>
      <b> 100 points are worth 0.37$ (about 51 Shilling).  </b>
     ...
     var star_instructions = {
      ...
      stimulus: function(){
        return `
         ...
         <p>${globalgroup_text} wins if you gather more points than ${globalothergroup_text}. The winning team gets a bonus payment of 0.74$ (about 103 Shilling). </br> </br></p> 
 ...
 var star_test_stimuli = [
    ...
    var choice_instructions1 = {
      ...
      <p> 100 points are worth 0.37$ (about 51 Shilling). Each decision you make has the same chance to be picked to be paid out.<p/> 
    ...
    var lookcheck_trial = {
      ...
      stimulus: function() {
        return `
         <p>In this task, you have 100 points that are worth 0.37$ (about 51 Shilling).</p> 
